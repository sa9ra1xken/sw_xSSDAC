# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
# 37 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c"
...
# 38 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
...
# 39 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
...
# 40 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/FLAC/assert.h" 1
# 41 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/FLAC/format.h" 1
# 36 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/FLAC/format.h"
...
# 37 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/FLAC/format.h" 2
...
# 42 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
...
# 43 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
...
# 45 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/private/macros.h" 1
# 46 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c" 2
# 58 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c"
         ...
         const uint32_t FLAC__STREAM_SYNC_LEN = 32;

         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_MIN_BLOCK_SIZE_LEN = 16;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_MAX_BLOCK_SIZE_LEN = 16;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_MIN_FRAME_SIZE_LEN = 24;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_MAX_FRAME_SIZE_LEN = 24;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_SAMPLE_RATE_LEN = 20;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_CHANNELS_LEN = 3;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_BITS_PER_SAMPLE_LEN = 5;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_TOTAL_SAMPLES_LEN = 36;
         const uint32_t FLAC__STREAM_METADATA_STREAMINFO_MD5SUM_LEN = 128;

         const uint32_t FLAC__STREAM_METADATA_APPLICATION_ID_LEN = 32;

         const uint32_t FLAC__STREAM_METADATA_SEEKPOINT_SAMPLE_NUMBER_LEN = 64;
         const uint32_t FLAC__STREAM_METADATA_SEEKPOINT_STREAM_OFFSET_LEN = 64;
         const uint32_t FLAC__STREAM_METADATA_SEEKPOINT_FRAME_SAMPLES_LEN = 16;

         const FLAC__uint64 FLAC__STREAM_METADATA_SEEKPOINT_PLACEHOLDER = 0xffffffffffffffffULL;

         const uint32_t FLAC__STREAM_METADATA_VORBIS_COMMENT_ENTRY_LENGTH_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_VORBIS_COMMENT_NUM_COMMENTS_LEN = 32;

         const uint32_t FLAC__STREAM_METADATA_CUESHEET_INDEX_OFFSET_LEN = 64;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_INDEX_NUMBER_LEN = 8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_INDEX_RESERVED_LEN = 3*8;

         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_OFFSET_LEN = 64;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_NUMBER_LEN = 8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_ISRC_LEN = 12*8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_TYPE_LEN = 1;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_PRE_EMPHASIS_LEN = 1;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_RESERVED_LEN = 6+13*8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_TRACK_NUM_INDICES_LEN = 8;

         const uint32_t FLAC__STREAM_METADATA_CUESHEET_MEDIA_CATALOG_NUMBER_LEN = 128*8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_LEAD_IN_LEN = 64;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_IS_CD_LEN = 1;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_RESERVED_LEN = 7+258*8;
         const uint32_t FLAC__STREAM_METADATA_CUESHEET_NUM_TRACKS_LEN = 8;

         const uint32_t FLAC__STREAM_METADATA_PICTURE_TYPE_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_MIME_TYPE_LENGTH_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_DESCRIPTION_LENGTH_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_WIDTH_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_HEIGHT_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_DEPTH_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_COLORS_LEN = 32;
         const uint32_t FLAC__STREAM_METADATA_PICTURE_DATA_LENGTH_LEN = 32;

         const uint32_t FLAC__STREAM_METADATA_IS_LAST_LEN = 1;
         const uint32_t FLAC__STREAM_METADATA_TYPE_LEN = 7;
         const uint32_t FLAC__STREAM_METADATA_LENGTH_LEN = 24;

         const uint32_t FLAC__FRAME_HEADER_SYNC = 0x3ffe;
         const uint32_t FLAC__FRAME_HEADER_SYNC_LEN = 14;
         const uint32_t FLAC__FRAME_HEADER_RESERVED_LEN = 1;
         const uint32_t FLAC__FRAME_HEADER_BLOCKING_STRATEGY_LEN = 1;
         const uint32_t FLAC__FRAME_HEADER_BLOCK_SIZE_LEN = 4;
         const uint32_t FLAC__FRAME_HEADER_SAMPLE_RATE_LEN = 4;
         const uint32_t FLAC__FRAME_HEADER_CHANNEL_ASSIGNMENT_LEN = 4;
         const uint32_t FLAC__FRAME_HEADER_BITS_PER_SAMPLE_LEN = 3;
         const uint32_t FLAC__FRAME_HEADER_ZERO_PAD_LEN = 1;
         const uint32_t FLAC__FRAME_HEADER_CRC_LEN = 8;

         const uint32_t FLAC__FRAME_FOOTER_CRC_LEN = 16;

         const uint32_t FLAC__ENTROPY_CODING_METHOD_TYPE_LEN = 2;
         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_ORDER_LEN = 4;
         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_PARAMETER_LEN = 4;
         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE2_PARAMETER_LEN = 5;
         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_RAW_LEN = 5;

         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_ESCAPE_PARAMETER = 15;
         const uint32_t FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE2_ESCAPE_PARAMETER = 31;
 ...
 "PARTITIONED_RICE2"
         ...
         const uint32_t FLAC__SUBFRAME_LPC_QLP_COEFF_PRECISION_LEN = 4;
         const uint32_t FLAC__SUBFRAME_LPC_QLP_SHIFT_LEN = 5;

         const uint32_t FLAC__SUBFRAME_ZERO_PAD_LEN = 1;
         const uint32_t FLAC__SUBFRAME_TYPE_LEN = 6;
         const uint32_t FLAC__SUBFRAME_WASTED_BITS_FLAG_LEN = 1;
 ...
 "Publisher/Studio logotype"
         ...
         FLAC__bool FLAC__format_sample_rate_is_valid(uint32_t sample_rate)
{
 if(sample_rate == 0 || sample_rate > (1048575u)) {
  return 0;
 }
 else
  return 1;
         ...
         FLAC__bool FLAC__format_sample_rate_is_subset(uint32_t sample_rate)
{
 if(
  ...
  sample_rate >= ((1u << 16) * 10) ||
  (sample_rate >= (1u << 16) && sample_rate % 10 != 0)
 ) {
  return 0;
 }
 else
...
# 538 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_libFLAC/source/format.c"
uint32_t FLAC__format_get_max_rice_partition_order_from_blocksize(uint32_t blocksize)
{
 ...
 return (((15u)) <= (max_rice_partition_order) ? ((15u)) : (max_rice_partition_order));
}
