# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.h" 1
# 12 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.h"
void out_led_port(unsigned bit, unsigned value);
# 2 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c" 2
...
# 3 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c" 2
...
# 4 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c" 2

swlock_t led_swlock = 0;
# 17 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE/module_human_interface/src/led_port_access.c"
unsigned p_led_peek()
{
    unsigned portId, x;
...
void write_led_port(unsigned bitmask, unsigned value)
{
 ...
 port_shadow = p_led_peek();
 if (value == 0) port_shadow &= ~bitmask;
 else port_shadow |= bitmask;
 p_led_out(port_shadow);
}
