...
unsigned outAudioBuff[((4 * (((((384000)+7999)/8000))+3) * (2))>(4 * ((((96000 +999)/1000))+3) * ((2))) ? (4 * (((((384000)+7999)/8000))+3) * (2)) : (4 * ((((96000 +999)/1000))+3) * ((2)))) + (1028>>2) + 4];
unsigned audioBuffIn[((4 * (((((384000)+7999)/8000))+3) * (0))>(4 * ((((96000 +999)/1000))+3) * ((0))) ? (4 * (((((384000)+7999)/8000))+3) * (0)) : (4 * ((((96000 +999)/1000))+3) * ((0)))) + ((((((96000/1000+1)*((0))*4))>((((384000)/8000+1)*(0)*4)) ? (((96000/1000+1)*((0))*4)) : ((((384000)/8000+1)*(0)*4))))>>2) + 4];

unsigned inZeroBuff[((((((96000/1000+1)*((0))*4))>((((384000)/8000+1)*(0)*4)) ? (((96000/1000+1)*((0))*4)) : ((((384000)/8000+1)*(0)*4))))>>2)+4];
...
int g_maxPacketSize = (((384000)/8000+1)*(0)*4);
...
#pragma xta endpoint "out_underflow"
 ...
 for(int i = 0; i < (2); i++)
        ...
        if (outSamps < 0)
        {
            outSamps += ((4 * (((((384000)+7999)/8000))+3) * (2))>(4 * ((((96000 +999)/1000))+3) * ((2))) ? (4 * (((((384000)+7999)/8000))+3) * (2)) : (4 * ((((96000 +999)/1000))+3) * ((2))))*4;
        }


        if(outSamps >= ((((((2))*((((96000 +999)/1000))+3)*3+4)>((2)*(((((384000)+7999)/8000))+3)*4+4) ? (((2))*((((96000 +999)/1000))+3)*3+4) : ((2)*(((((384000)+7999)/8000))+3)*4+4))*1)))
        {
            outUnderflow = 0;
            outSamps++;
        }
...
# 359 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/usb_buffer/decouple.xc"
        ...
        for(int i = 0; i < (0) - g_numUsbChan_In; i++)
        {
...
# 475 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < (((4 * (((((384000)+7999)/8000))+3) * (0))>(4 * ((((96000 +999)/1000))+3) * ((0))) ? (4 * (((((384000)+7999)/8000))+3) * (0)) : (4 * ((((96000 +999)/1000))+3) * ((0))))*4/2));
            }
...
)
{
    ...
    aud_from_host_fifo_end = aud_from_host_fifo_start + ((4 * (((((384000)+7999)/8000))+3) * (2))>(4 * ((((96000 +999)/1000))+3) * ((2))) ? (4 * (((((384000)+7999)/8000))+3) * (2)) : (4 * ((((96000 +999)/1000))+3) * ((2))))*4;
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + ((4 * (((((384000)+7999)/8000))+3) * (0))>(4 * ((((96000 +999)/1000))+3) * ((0))) ? (4 * (((((384000)+7999)/8000))+3) * (0)) : (4 * ((((96000 +999)/1000))+3) * ((0))))*4;
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
...
# 694 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/usb_buffer/decouple.xc"
        {
            ...
            else if(tmp == 9)
            {
                ...
                {
                    g_maxPacketSize = (((96000/1000+1)*4) * g_numUsbChan_In);
                }
            ...
            else if(tmp == 8)
            {
                ...
                update_stream_format(g_numUsbChan_Out, sampRes);
...
# 827 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/usb_buffer/decouple.xc"
        ...
        else if (outOverflow)
        {
            ...
            space_left = aud_from_host_rdptr - aud_from_host_wrptr;
            if (space_left <= 0)
                space_left += ((4 * (((((384000)+7999)/8000))+3) * (2))>(4 * ((((96000 +999)/1000))+3) * ((2))) ? (4 * (((((384000)+7999)/8000))+3) * (2)) : (4 * ((((96000 +999)/1000))+3) * ((2))))*4;
            if (space_left >= (((4 * (((((384000)+7999)/8000))+3) * (2))>(4 * ((((96000 +999)/1000))+3) * ((2))) ? (4 * (((((384000)+7999)/8000))+3) * (2)) : (4 * ((((96000 +999)/1000))+3) * ((2))))*4/2))
            {
