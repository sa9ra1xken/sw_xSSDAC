	...
	.set usage.anon.12,0
	.set usage.anon.13,0
	.globwrite config_audio_source,track_string,255,1,"../src/main.xc:203:5: note: object used here (bytes 255..256)\n    track_string[TRACK_STRING_SIZE-1]=\'\\0\';\n    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globwrite config_audio_source,track_string,"../src/main.xc:202:52: note: object used here\n    i.read(TRACK_STRING_OFFSET, TRACK_STRING_SIZE, track_string);\n                                                   ^~~~~~~~~~~~"
	.globwrite config_audio_source,folder_string,255,1,"../src/main.xc:201:5: note: object used here (bytes 255..256)\n    folder_string[FOLDER_STRING_SIZE-1]=\'\\0\';\n    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globwrite config_audio_source,folder_string,"../src/main.xc:200:54: note: object used here\n    i.read(FOLDER_STRING_OFFSET, FOLDER_STRING_SIZE, folder_string);\n                                                     ^~~~~~~~~~~~~"
	.globwrite usage.anon.7,epTypeTableIn,"../src/main.xc:124:36: note: object used here\n            c_sof, epTypeTableOut, epTypeTableIn, p_usb_rst,\n                                   ^~~~~~~~~~~~~"
	.globwrite usage.anon.7,epTypeTableOut,"../src/main.xc:124:20: note: object used here\n            c_sof, epTypeTableOut, epTypeTableIn, p_usb_rst,\n                   ^~~~~~~~~~~~~~"
	...
	.par usage.anon.11,usage.anon.12,"../src/main.xc:238:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.11,usage.anon.13,"../src/main.xc:238:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.12,usage.anon.13,"../src/main.xc:238:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par display_control_core,sdcard_play,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par display_control_core,decoupler,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par display_control_core,button_listener_core,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par sdcard_play,decoupler,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par sdcard_play,button_listener_core,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par decoupler,button_listener_core,"../src/main.xc:220:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par usb_audio_core,button_listener_core,"../src/main.xc:210:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par usb_audio_core,display_control_core,"../src/main.xc:210:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par button_listener_core,display_control_core,"../src/main.xc:210:9: error: use of `%s\' violates parallel usage rules\n        par\n        ^~~"
	.par usage.anon.7,usage.anon.8,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.7,usage.anon.9,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.7,usage.anon.10,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.8,usage.anon.9,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.8,usage.anon.10,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	.par usage.anon.9,usage.anon.10,"../src/main.xc:119:5: error: use of `%s\' violates parallel usage rules\n    par\n    ^~~"
	...
	.globpassesref XUD_Manager, epTypeTableIn,"../src/main.xc:123:9: error: call to `XUD_Manager\' in `usb_audio_core\' makes alias of global \'epTypeTableIn\'\n        XUD_Manager(c_xud_out, ENDPOINT_COUNT_OUT, c_xud_in, ENDPOINT_COUNT_IN,\n        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref XUD_Manager, epTypeTableOut,"../src/main.xc:123:9: error: call to `XUD_Manager\' in `usb_audio_core\' makes alias of global \'epTypeTableOut\'\n        XUD_Manager(c_xud_out, ENDPOINT_COUNT_OUT, c_xud_in, ENDPOINT_COUNT_IN,\n        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
.Lxtalabel0:
	...
	.loc	1 78 0 prologue_end     # ../src/main.xc:78:0
.Ltmp34:
	setsr 128
	{
		nop
...
.Ltmp38:
	.cfi_offset 15, 0
	.loc	1 88 0 prologue_end     # ../src/main.xc:88:0
.Ltmp39:
	ldaw r11, cp[.str3]
	{
		nop
...
.Ltmp43:
	...
	.loc	1 102 0 prologue_end    # ../src/main.xc:102:0
.Ltmp44:
	{
		ldaw r1, sp[5]
		ldaw r2, sp[6]
...
.Ltmp55:
	...
	.loc	1 123 0 prologue_end    # ../src/main.xc:123:0
.Ltmp56:
	ldaw r11, r0[10]
	{
		ldc r1, 56
...
.Ltmp88:
	...
	.loc	1 197 0 prologue_end    # ../src/main.xc:197:0
.Ltmp89:
	{
		ldaw r3, sp[5]
		ldw r11, r0[1]
...
.Ltmp96:
	.loc	1 212 0 prologue_end    # ../src/main.xc:212:0
.Lxta.call_labels13:
	bl usb_audio_core
	{
		nop
...
.Ltmp100:
	...
	.loc	1 213 0 prologue_end    # ../src/main.xc:213:0
.Ltmp101:
	{
		mov r0, r3
		ldw r2, r0[2]
...
.Ltmp112:
	.loc	1 222 0 prologue_end    # ../src/main.xc:222:0
.Lxta.call_labels16:
	bl _Sdisplay_control_core_0
.Ltmp113:
...
.Ltmp116:
	...
	.loc	1 223 0 prologue_end    # ../src/main.xc:223:0
.Ltmp117:
	{
		mov r0, r2
		ldw r1, r0[4]
...
.Ltrap_info_str0:
.asciiz"../src/main.xc:201:5: error: out of bounds array access\n    folder_string[FOLDER_STRING_SIZE-1]='\\0';\n    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
