...
.Lxta.call_labels0:
	...
	.loc	1 74 5                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:5
	bf r0, .LBB4_3
# BB#1:                                 # %iftrue
.Lxtalabel1:
...
.Ltmp30:
	#DEBUG_VALUE: qspi_server:i <- R4
	.loc	1 80 0                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:80:0
	bl fl_getFlashType
	{
		mov r1, r0
		nop
...
.Lxta.call_labels3:
	bl debug_printf
	.loc	1 82 0                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:82:0
...
.Lxta.call_labels5:
	...
	.loc	1 84 0                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:84:0
	{
		mov r0, r8
		nop
	}
...
.Ltmp41:
	...
	.loc	1 101 13                # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:101:13
	bf r10, .LBB4_6
.Ltmp42:
# BB#8:                                 # %iffalse
                                        #   in Loop: Header=BB4_4 Depth=1
...
.Ltmp92:
	...
	.set	_Sqspi_server_0.maxcores,__interface_block_load.maxcores $M __interface_block_store.maxcores $M _safe_malloc.maxcores $M debug_printf.maxcores $M fl_connectToDevice.maxcores $M fl_getDataPartitionSize.maxcores $M fl_getDataSectorSize.maxcores $M fl_getFlashSize.maxcores $M fl_getFlashType.maxcores $M fl_getNumDataSectors.maxcores $M fl_getWriteScratchSize.maxcores $M fl_readData.maxcores $M fl_writeData.maxcores $M free.maxcores $M 1
	.globl	_Sqspi_server_0.maxcores
	.set	_Sqspi_server_0.maxtimers,__interface_block_load.maxtimers $M __interface_block_store.maxtimers $M _safe_malloc.maxtimers $M debug_printf.maxtimers $M fl_connectToDevice.maxtimers $M fl_getDataPartitionSize.maxtimers $M fl_getDataSectorSize.maxtimers $M fl_getFlashSize.maxtimers $M fl_getFlashType.maxtimers $M fl_getNumDataSectors.maxtimers $M fl_getWriteScratchSize.maxtimers $M fl_readData.maxtimers $M fl_writeData.maxtimers $M free.maxtimers $M 0
	.globl	_Sqspi_server_0.maxtimers
	.set	_Sqspi_server_0.maxchanends,__interface_block_load.maxchanends $M __interface_block_store.maxchanends $M _safe_malloc.maxchanends $M debug_printf.maxchanends $M fl_connectToDevice.maxchanends $M fl_getDataPartitionSize.maxchanends $M fl_getDataSectorSize.maxchanends $M fl_getFlashSize.maxchanends $M fl_getFlashType.maxchanends $M fl_getNumDataSectors.maxchanends $M fl_getWriteScratchSize.maxchanends $M fl_readData.maxchanends $M fl_writeData.maxchanends $M free.maxchanends $M 0
...
.asciiz"Flash fl_getWriteScratchSize(0, 64): %d\n"
	...
	.size	.str13, 39
.str13:
.asciiz"\nquadflash write sync offset, %d %d %s"
	...
	.size	.str14, 35
.str14:
.asciiz"- couldn't allocate scratch memory"
...
.cc_bottom cc_22
.cc_top cc_23,.Lxta.call_labels33
	.ascii	"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc"
	.byte	0
	.long	102
