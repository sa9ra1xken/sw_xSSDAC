...
.sameresource __xcc1_internal_4, ports, 12
	...
	.set usage.anon.4,0
	.set usage.anon.5,0
	.globread qspi_server,deviceSpecs,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:34: note: object used here\n    if(fl_connectToDevice(ports, deviceSpecs, sizeof(deviceSpecs)/sizeof(fl_QuadDeviceSpec)) != 0)\n                                 ^~~~~~~~~~~"
	.globwrite qspi_server,ports,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:27: note: object used here\n    if(fl_connectToDevice(ports, deviceSpecs, sizeof(deviceSpecs)/sizeof(fl_QuadDeviceSpec)) != 0)\n                          ^~~~~"
	...
	.assert 1,memset.actnoglobalaccess,"In file included from C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:43:\nIn file included from C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\string.h:5:\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\safe/string.h:21:3: error: passing non-local alias to function `memset\' which accesses a global variable\n  memset(s, c, n);\n  ^~~~~~~~~~~~~~~"
	.assert 1,memmove.actnoglobalaccess,"In file included from C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:43:\nIn file included from C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\string.h:5:\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\safe/string.h:15:3: error: passing non-local alias to function `memmove\' which accesses a global variable\n  memmove(s1, s2, n);\n  ^~~~~~~~~~~~~~~~~~"
	.assert 1,free.actnoglobalaccess,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:113:13: error: passing non-local alias to function `free\' which accesses a global variable\n            free(write_buffer);\n            ^~~~~~~~~~~~~~~~~~\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\stdlib.h:12:17: note: expanded from macro \'free\'\n#define free(s) free(s)\n                ^~~~~~~"
	.assert 1,fl_writeData.actnoglobalaccess,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:20: error: passing non-local alias to function `fl_writeData\' which accesses a global variable\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,fl_readData.actnoglobalaccess,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:128:27: error: passing non-local alias to function `fl_readData\' which accesses a global variable\n                int rc2 = fl_readData(offset, size, read_buffer);\n                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref fl_connectToDevice, deviceSpecs,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:8: error: call to `fl_connectToDevice\' in `qspi_server\' makes alias of global \'deviceSpecs\'\n    if(fl_connectToDevice(ports, deviceSpecs, sizeof(deviceSpecs)/sizeof(fl_QuadDeviceSpec)) != 0)\n       ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref fl_connectToDevice, ports,"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:8: error: call to `fl_connectToDevice\' in `qspi_server\' makes alias of global \'ports\'\n    if(fl_connectToDevice(ports, deviceSpecs, sizeof(deviceSpecs)/sizeof(fl_QuadDeviceSpec)) != 0)\n       ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
.Lfunc_begin4:
	.loc	1 71 0                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:71:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp28:
	...
	.loc	1 74 5 prologue_end     # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:74:5
.Ltmp29:
	ldaw r0, dp[ports]
...
.LBB4_2:                                # %LoopTest
	...
	.loc	1 77 9                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:77:9
	bu .LBB4_2
.LBB4_1:
.Ltmp30:
	#DEBUG_VALUE: qspi_server:i <- R4
...
.LBB4_9:                                # %switchcase65
	...
	#DEBUG_VALUE: size <- R7
	.loc	1 121 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:121:0
	{
		lsu r0, r9, r7
		nop
	}
...
.Lxtalabel1:
	#DEBUG_VALUE: qspi_server:i <- R4
	.loc	1 94 9                  # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:94:9
	{
		zext r0, 1
		nop
	}
...
.Lxtalabel2:
	#DEBUG_VALUE: qspi_server:i <- R4
	#DEBUG_VALUE: qspi_server:i <- [SP+20]
	.loc	1 117 9                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:117:9
	{
		clre
		ldw r10, r4[0]
	}
...
.Ltrap_info2:
	...
	#DEBUG_VALUE: qspi_server:i <- R4
	.loc	1 106 17                # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:17
	{
		sub r0, r11, r5
		nop
	}
...
.Lxta.call_labels3:
	bl fl_writeData
	.loc	1 111 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:111:0
	{
		mov r0, r10
		nop
	}
...
.Lxtalabel6:
	#DEBUG_VALUE: qspi_server:i <- R4
	.loc	1 113 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:113:0
	{
		mov r0, r6
		nop
	}
...
.LBB4_8:                                # %switchcase
	...
	#DEBUG_VALUE: qspi_server:i <- [SP+20]
	.loc	1 128 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:128:0
	{
		lsu r0, r11, r5
		nop
	}
...
.Lxta.call_labels6:
	bl fl_readData
	.loc	1 129 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:129:0
	{
		lsu r0, r9, r7
		nop
	}
...
.Ltmp82:
	...
	.set	_Sqspi_server_0.nstackwords,((fl_connectToDevice.nstackwords $M __interface_block_load.nstackwords $M fl_readData.nstackwords $M __interface_block_store.nstackwords $M fl_getWriteScratchSize.nstackwords $M _safe_malloc.nstackwords $M fl_writeData.nstackwords $M free.nstackwords) + 14)
	.globl	_Sqspi_server_0.nstackwords
	.set	_Sqspi_server_0.maxcores,__interface_block_load.maxcores $M __interface_block_store.maxcores $M _safe_malloc.maxcores $M fl_connectToDevice.maxcores $M fl_getWriteScratchSize.maxcores $M fl_readData.maxcores $M fl_writeData.maxcores $M free.maxcores $M 1
	.globl	_Sqspi_server_0.maxcores
	.set	_Sqspi_server_0.maxtimers,__interface_block_load.maxtimers $M __interface_block_store.maxtimers $M _safe_malloc.maxtimers $M fl_connectToDevice.maxtimers $M fl_getWriteScratchSize.maxtimers $M fl_readData.maxtimers $M fl_writeData.maxtimers $M free.maxtimers $M 0
	.globl	_Sqspi_server_0.maxtimers
	.set	_Sqspi_server_0.maxchanends,__interface_block_load.maxchanends $M __interface_block_store.maxchanends $M _safe_malloc.maxchanends $M fl_connectToDevice.maxchanends $M fl_getWriteScratchSize.maxchanends $M fl_readData.maxchanends $M fl_writeData.maxchanends $M free.maxchanends $M 0
	.globl	_Sqspi_server_0.maxchanends
.Ltmp83:
	.size	_Sqspi_server_0, .Ltmp83-_Sqspi_server_0
.Lfunc_end5:
	.cfi_endproc
...
.Lfunc_begin6:
	.loc	1 141 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:141:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel16:
...
.Ltmp88:
	...
	.loc	1 142 0 prologue_end    # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:142:0
.Ltmp89:
	{
		mov r0, r11
		stw r4, sp[1]
...
.Ltmp92:
	.size	qspi_if_write, .Ltmp92-qspi_if_write
.Lfunc_end6:
	.cfi_endproc
...
.Lfunc_begin7:
	.loc	1 136 0                 # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:136:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel17:
...
.Ltmp97:
	...
	.loc	1 137 0 prologue_end    # C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:137:0
.Ltmp98:
	{
		mov r0, r11
		stw r4, sp[1]
...
.Ltmp101:
	.size	qspi_if_read, .Ltmp101-qspi_if_read
.Lfunc_end7:
	.cfi_endproc
...
.L.debug_info_begin0:
	...
	.byte	0                       # End Of Children Mark
	.byte	0                       # End Of Children Mark
	.byte	11                      # Abbrev [11] 0x3b2:0xf9 DW_TAG_subprogram
	...
	.byte	71                      # DW_AT_decl_line
	.long	1777                    # DW_AT_type
	.byte	13                      # Abbrev [13] 0x3d4:0xd6 DW_TAG_lexical_block
	.long	.Ldebug_ranges17        # DW_AT_ranges
	.byte	14                      # Abbrev [14] 0x3d9:0xb DW_TAG_variable
	.long	.Linfo_string81         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	87                      # DW_AT_decl_line
	.long	1722                    # DW_AT_type
	.byte	13                      # Abbrev [13] 0x3e4:0xc5 DW_TAG_lexical_block
	...
	.byte	88                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	13                      # Abbrev [13] 0x3f8:0xb0 DW_TAG_lexical_block
	.long	.Ldebug_ranges15        # DW_AT_ranges
	.byte	14                      # Abbrev [14] 0x3fd:0xb DW_TAG_variable
	.long	.Linfo_string82         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	89                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	13                      # Abbrev [13] 0x408:0x9f DW_TAG_lexical_block
	.long	.Ldebug_ranges14        # DW_AT_ranges
	.byte	15                      # Abbrev [15] 0x40d:0xf DW_TAG_variable
	.long	.Ldebug_loc5            # DW_AT_location
	.long	.Linfo_string78         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	126                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	14                      # Abbrev [14] 0x41c:0xb DW_TAG_variable
	.long	.Linfo_string83         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	90                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	14                      # Abbrev [14] 0x427:0xb DW_TAG_variable
	.long	.Linfo_string85         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	126                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	14                      # Abbrev [14] 0x432:0xb DW_TAG_variable
	.long	.Linfo_string86         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	126                     # DW_AT_decl_line
	.long	1784                    # DW_AT_type
	.byte	14                      # Abbrev [14] 0x43d:0xb DW_TAG_variable
	.long	.Linfo_string85         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	118                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	14                      # Abbrev [14] 0x448:0xb DW_TAG_variable
	.long	.Linfo_string78         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	118                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	14                      # Abbrev [14] 0x453:0xb DW_TAG_variable
	.long	.Linfo_string86         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	118                     # DW_AT_decl_line
	.long	1784                    # DW_AT_type
	.byte	13                      # Abbrev [13] 0x45e:0x26 DW_TAG_lexical_block
	.long	.Ldebug_ranges11        # DW_AT_ranges
	.byte	15                      # Abbrev [15] 0x463:0xf DW_TAG_variable
	.long	.Ldebug_loc7            # DW_AT_location
	.long	.Linfo_string80         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	96                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	13                      # Abbrev [13] 0x472:0x11 DW_TAG_lexical_block
	.long	.Ldebug_ranges10        # DW_AT_ranges
	.byte	14                      # Abbrev [14] 0x477:0xb DW_TAG_variable
	.long	.Linfo_string84         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	99                      # DW_AT_decl_line
	.long	1722                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	0                       # End Of Children Mark
	.byte	13                      # Abbrev [13] 0x484:0x22 DW_TAG_lexical_block
	.long	.Ldebug_ranges13        # DW_AT_ranges
	.byte	14                      # Abbrev [14] 0x489:0xb DW_TAG_variable
	.long	.Linfo_string87         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	127                     # DW_AT_decl_line
	.long	1722                    # DW_AT_type
	.byte	13                      # Abbrev [13] 0x494:0x11 DW_TAG_lexical_block
	.long	.Ldebug_ranges12        # DW_AT_ranges
	.byte	14                      # Abbrev [14] 0x499:0xb DW_TAG_variable
	.long	.Linfo_string88         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	128                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	...
	.byte	0                       # End Of Children Mark
	.byte	0                       # End Of Children Mark
	.byte	11                      # Abbrev [11] 0x4ab:0x50 DW_TAG_subprogram
	...
	.byte	140                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	12                      # Abbrev [12] 0x4dc:0xf DW_TAG_formal_parameter
	.long	.Ldebug_loc10           # DW_AT_location
	.long	.Linfo_string78         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	140                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	12                      # Abbrev [12] 0x4eb:0xf DW_TAG_formal_parameter
	...
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	11                      # Abbrev [11] 0x4fb:0x50 DW_TAG_subprogram
	...
	.byte	1                       # DW_AT_external
	.byte	12                      # Abbrev [12] 0x50e:0xf DW_TAG_formal_parameter
	.long	.Ldebug_loc12           # DW_AT_location
	.long	.Linfo_string76         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	135                     # DW_AT_decl_line
	.long	1777                    # DW_AT_type
	.byte	12                      # Abbrev [12] 0x51d:0xf DW_TAG_formal_parameter
	.long	.Ldebug_loc13           # DW_AT_location
	.long	.Linfo_string85         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	135                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	12                      # Abbrev [12] 0x52c:0xf DW_TAG_formal_parameter
	.long	.Ldebug_loc14           # DW_AT_location
	.long	.Linfo_string78         # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	135                     # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	12                      # Abbrev [12] 0x53b:0xf DW_TAG_formal_parameter
	...
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	16                      # Abbrev [16] 0x54b:0x2f DW_TAG_subprogram
	.long	.Linfo_string62         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string62         # DW_AT_name
	.byte	1                       # DW_AT_external
	.byte	17                      # Abbrev [17] 0x555:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string89         # DW_AT_name
	.long	1794                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x55e:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string91         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x567:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string92         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x570:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string93         # DW_AT_name
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	16                      # Abbrev [16] 0x57a:0x2f DW_TAG_subprogram
	.long	.Linfo_string63         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string63         # DW_AT_name
	.byte	1                       # DW_AT_external
	.byte	17                      # Abbrev [17] 0x584:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string89         # DW_AT_name
	.long	1794                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x58d:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string91         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x596:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string92         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x59f:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string93         # DW_AT_name
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	16                      # Abbrev [16] 0x5a9:0x2f DW_TAG_subprogram
	.long	.Linfo_string64         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string64         # DW_AT_name
	.byte	1                       # DW_AT_external
	.byte	17                      # Abbrev [17] 0x5b3:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string94         # DW_AT_name
	.long	1801                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5bc:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string91         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5c5:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string92         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5ce:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string93         # DW_AT_name
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	16                      # Abbrev [16] 0x5d8:0x2f DW_TAG_subprogram
	.long	.Linfo_string65         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string65         # DW_AT_name
	.byte	1                       # DW_AT_external
	.byte	17                      # Abbrev [17] 0x5e2:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string94         # DW_AT_name
	.long	1801                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5eb:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string91         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5f4:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string92         # DW_AT_name
	.long	1665                    # DW_AT_type
	.byte	17                      # Abbrev [17] 0x5fd:0x9 DW_TAG_formal_parameter
	.long	.Linfo_string93         # DW_AT_name
	.long	1784                    # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	18                      # Abbrev [18] 0x607:0x18 DW_TAG_subprogram
	.long	.Linfo_string66         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string66         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	46                      # DW_AT_decl_line
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x613:0xb DW_TAG_formal_parameter
	.long	.Linfo_string97         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	46                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	18                      # Abbrev [18] 0x61f:0x18 DW_TAG_subprogram
	.long	.Linfo_string67         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string67         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	54                      # DW_AT_decl_line
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x62b:0xb DW_TAG_formal_parameter
	.long	.Linfo_string97         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	54                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	18                      # Abbrev [18] 0x637:0x18 DW_TAG_subprogram
	.long	.Linfo_string68         # DW_AT_MIPS_linkage_name
	.long	.Linfo_string68         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	62                      # DW_AT_decl_line
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x643:0xb DW_TAG_formal_parameter
	.long	.Linfo_string97         # DW_AT_name
	.byte	2                       # DW_AT_decl_file
	.byte	62                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	20                      # Abbrev [20] 0x64f:0x32 DW_TAG_subprogram
	...
	.long	1665                    # DW_AT_type
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x65f:0xb DW_TAG_formal_parameter
	.long	.Linfo_string98         # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	8                       # DW_AT_decl_line
	.long	1833                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x66a:0xb DW_TAG_formal_parameter
	.long	.Linfo_string99         # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	8                       # DW_AT_decl_line
	.long	1833                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x675:0xb DW_TAG_formal_parameter
	.long	.Linfo_string100        # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	8                       # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	5                       # Abbrev [5] 0x681:0x7 DW_TAG_base_type
	.long	.Linfo_string70         # DW_AT_name
	.byte	5                       # DW_AT_encoding
	.byte	4                       # DW_AT_byte_size
	.byte	20                      # Abbrev [20] 0x688:0x32 DW_TAG_subprogram
	...
	.long	1722                    # DW_AT_type
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x698:0xb DW_TAG_formal_parameter
	.long	.Linfo_string98         # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	12                      # DW_AT_decl_line
	.long	1722                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x6a3:0xb DW_TAG_formal_parameter
	.long	.Linfo_string99         # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	12                      # DW_AT_decl_line
	.long	1833                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x6ae:0xb DW_TAG_formal_parameter
	.long	.Linfo_string100        # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	12                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	21                      # Abbrev [21] 0x6ba:0x5 DW_TAG_pointer_type
	.long	451                     # DW_AT_type
	.byte	20                      # Abbrev [20] 0x6bf:0x32 DW_TAG_subprogram
	...
	.long	1722                    # DW_AT_type
	.byte	1                       # DW_AT_external
	.byte	19                      # Abbrev [19] 0x6cf:0xb DW_TAG_formal_parameter
	.long	.Linfo_string94         # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	18                      # DW_AT_decl_line
	.long	1722                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x6da:0xb DW_TAG_formal_parameter
	.long	.Linfo_string101        # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	18                      # DW_AT_decl_line
	.long	1665                    # DW_AT_type
	.byte	19                      # Abbrev [19] 0x6e5:0xb DW_TAG_formal_parameter
	.long	.Linfo_string100        # DW_AT_name
	.byte	3                       # DW_AT_decl_file
	.byte	18                      # DW_AT_decl_line
	.long	444                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	5                       # Abbrev [5] 0x6f1:0x7 DW_TAG_base_type
	.long	.Linfo_string77         # DW_AT_name
	.byte	7                       # DW_AT_encoding
	.byte	4                       # DW_AT_byte_size
	.byte	22                      # Abbrev [22] 0x6f8:0x5 DW_TAG_reference_type
	.long	1789                    # DW_AT_type
	.byte	23                      # Abbrev [23] 0x6fd:0x5 DW_TAG_array_type
	.long	451                     # DW_AT_type
	.byte	5                       # Abbrev [5] 0x702:0x7 DW_TAG_base_type
	.long	.Linfo_string90         # DW_AT_name
	.byte	7                       # DW_AT_encoding
	.byte	4                       # DW_AT_byte_size
	.byte	22                      # Abbrev [22] 0x709:0x5 DW_TAG_reference_type
	.long	1806                    # DW_AT_type
	.byte	24                      # Abbrev [24] 0x70e:0x1b DW_TAG_structure_type
	.long	.Linfo_string96         # DW_AT_name
	.byte	8                       # DW_AT_byte_size
	.byte	25                      # Abbrev [25] 0x714:0xa DW_TAG_member
	.long	.Linfo_string89         # DW_AT_name
	.long	1794                    # DW_AT_type
	.byte	0                       # DW_AT_data_member_location
	.byte	25                      # Abbrev [25] 0x71e:0xa DW_TAG_member
	.long	.Linfo_string95         # DW_AT_name
	.long	444                     # DW_AT_type
	.byte	4                       # DW_AT_data_member_location
	.byte	0                       # End Of Children Mark
	.byte	22                      # Abbrev [22] 0x729:0x5 DW_TAG_reference_type
	.long	1838                    # DW_AT_type
	.byte	23                      # Abbrev [23] 0x72e:0x5 DW_TAG_array_type
	.long	1843                    # DW_AT_type
	.byte	26                      # Abbrev [26] 0x733:0x5 DW_TAG_const_type
	.long	451                     # DW_AT_type
	.byte	0                       # End Of Children Mark
.L.debug_info_end0:
	.section	.debug_abbrev,"",@progbits
...
.Ldebug_loc0:
	.long	.Lfunc_begin4
	.long	.Ltmp27
.Lset0 = .Ltmp103-.Ltmp102              # Loc expr size
	.short	.Lset0
.Ltmp102:
	.byte	80                      # DW_OP_reg0
.Ltmp103:
	.long	.Ltmp27
	.long	.Ltmp28
.Lset1 = .Ltmp105-.Ltmp104              # Loc expr size
	.short	.Lset1
.Ltmp104:
	.byte	84                      # DW_OP_reg4
.Ltmp105:
	.long	.Ltmp30
	.long	.Ltmp31
.Lset2 = .Ltmp107-.Ltmp106              # Loc expr size
	.short	.Lset2
.Ltmp106:
	.byte	84                      # DW_OP_reg4
.Ltmp107:
	.long	.Ltmp31
	.long	.Ltmp33
.Lset3 = .Ltmp109-.Ltmp108              # Loc expr size
	.short	.Lset3
.Ltmp108:
...
.Ltmp109:
	.long	.Ltmp33
	.long	.Ltmp35
.Lset4 = .Ltmp111-.Ltmp110              # Loc expr size
	.short	.Lset4
.Ltmp110:
	.byte	84                      # DW_OP_reg4
.Ltmp111:
	.long	.Ltmp35
	.long	.Ltmp37
.Lset5 = .Ltmp113-.Ltmp112              # Loc expr size
	.short	.Lset5
.Ltmp112:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
.Ltmp113:
	.long	.Ltmp37
	.long	.Ltmp44
.Lset6 = .Ltmp115-.Ltmp114              # Loc expr size
	.short	.Lset6
.Ltmp114:
	.byte	84                      # DW_OP_reg4
.Ltmp115:
	.long	.Ltmp44
	.long	.Ltmp46
.Lset7 = .Ltmp117-.Ltmp116              # Loc expr size
	.short	.Lset7
.Ltmp116:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
.Ltmp117:
	.long	.Ltmp46
	.long	.Ltmp47
.Lset8 = .Ltmp119-.Ltmp118              # Loc expr size
	.short	.Lset8
.Ltmp118:
	.byte	81                      # DW_OP_reg1
.Ltmp119:
	.long	.Ltmp47
	.long	.Lfunc_end4
.Lset9 = .Ltmp121-.Ltmp120              # Loc expr size
	.short	.Lset9
.Ltmp120:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
...
.Ldebug_loc1:
	.long	.Ltmp31
	.long	.Ltmp34
.Lset10 = .Ltmp123-.Ltmp122             # Loc expr size
	.short	.Lset10
.Ltmp122:
	.byte	87                      # DW_OP_reg7
.Ltmp123:
...
.Ldebug_loc2:
	.long	.Ltmp32
	.long	.Ltmp44
.Lset11 = .Ltmp125-.Ltmp124             # Loc expr size
	.short	.Lset11
.Ltmp124:
...
.Ltmp125:
	.long	.Ltmp44
	.long	.Lfunc_end4
.Lset12 = .Ltmp127-.Ltmp126             # Loc expr size
	.short	.Lset12
.Ltmp126:
	.byte	16                      # DW_OP_constu
	.byte	0                       # 
...
.Ldebug_loc3:
	.long	.Ltmp38
	.long	.Ltmp39
.Lset13 = .Ltmp129-.Ltmp128             # Loc expr size
	.short	.Lset13
.Ltmp128:
	.byte	80                      # DW_OP_reg0
.Ltmp129:
...
.Ldebug_loc4:
	.long	.Lfunc_begin5
	.long	.Ltmp60
.Lset14 = .Ltmp131-.Ltmp130             # Loc expr size
	.short	.Lset14
.Ltmp130:
	.byte	80                      # DW_OP_reg0
.Ltmp131:
	.long	.Ltmp60
	.long	.Ltmp61
.Lset15 = .Ltmp133-.Ltmp132             # Loc expr size
	.short	.Lset15
.Ltmp132:
	.byte	84                      # DW_OP_reg4
.Ltmp133:
	.long	.Ltmp63
	.long	.Ltmp64
.Lset16 = .Ltmp135-.Ltmp134             # Loc expr size
	.short	.Lset16
.Ltmp134:
	.byte	84                      # DW_OP_reg4
.Ltmp135:
	.long	.Ltmp64
	.long	.Ltmp66
.Lset17 = .Ltmp137-.Ltmp136             # Loc expr size
	.short	.Lset17
.Ltmp136:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
.Ltmp137:
	.long	.Ltmp66
	.long	.Ltmp68
.Lset18 = .Ltmp139-.Ltmp138             # Loc expr size
	.short	.Lset18
.Ltmp138:
	.byte	84                      # DW_OP_reg4
.Ltmp139:
	.long	.Ltmp68
	.long	.Ltmp70
.Lset19 = .Ltmp141-.Ltmp140             # Loc expr size
	.short	.Lset19
.Ltmp140:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
.Ltmp141:
	.long	.Ltmp70
	.long	.Ltmp77
.Lset20 = .Ltmp143-.Ltmp142             # Loc expr size
	.short	.Lset20
.Ltmp142:
	.byte	84                      # DW_OP_reg4
.Ltmp143:
	.long	.Ltmp77
	.long	.Ltmp79
.Lset21 = .Ltmp145-.Ltmp144             # Loc expr size
	.short	.Lset21
.Ltmp144:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
.Ltmp145:
	.long	.Ltmp79
	.long	.Ltmp80
.Lset22 = .Ltmp147-.Ltmp146             # Loc expr size
	.short	.Lset22
.Ltmp146:
	.byte	81                      # DW_OP_reg1
.Ltmp147:
	.long	.Ltmp80
	.long	.Lfunc_end5
.Lset23 = .Ltmp149-.Ltmp148             # Loc expr size
	.short	.Lset23
.Ltmp148:
	.byte	126                     # DW_OP_breg14
	.byte	20                      # 
...
.Ldebug_loc5:
	.long	.Ltmp64
	.long	.Ltmp67
.Lset24 = .Ltmp151-.Ltmp150             # Loc expr size
	.short	.Lset24
.Ltmp150:
	.byte	87                      # DW_OP_reg7
.Ltmp151:
...
.Ldebug_loc6:
	.long	.Ltmp65
	.long	.Ltmp77
.Lset25 = .Ltmp153-.Ltmp152             # Loc expr size
	.short	.Lset25
.Ltmp152:
	.byte	16                      # DW_OP_constu
	.byte	1                       # 
.Ltmp153:
	.long	.Ltmp77
	.long	.Lfunc_end5
.Lset26 = .Ltmp155-.Ltmp154             # Loc expr size
	.short	.Lset26
.Ltmp154:
	.byte	16                      # DW_OP_constu
	.byte	0                       # 
...
.Ldebug_loc7:
	.long	.Ltmp71
	.long	.Ltmp72
.Lset27 = .Ltmp157-.Ltmp156             # Loc expr size
	.short	.Lset27
.Ltmp156:
	.byte	80                      # DW_OP_reg0
.Ltmp157:
...
.Ldebug_loc8:
	.long	.Lfunc_begin6
	.long	.Ltmp88
.Lset28 = .Ltmp159-.Ltmp158             # Loc expr size
	.short	.Lset28
.Ltmp158:
	.byte	80                      # DW_OP_reg0
.Ltmp159:
...
.Ldebug_loc9:
	.long	.Lfunc_begin6
	.long	.Ltmp90
.Lset29 = .Ltmp161-.Ltmp160             # Loc expr size
	.short	.Lset29
.Ltmp160:
	.byte	81                      # DW_OP_reg1
.Ltmp161:
...
.Ldebug_loc10:
	.long	.Lfunc_begin6
	.long	.Ltmp90
.Lset30 = .Ltmp163-.Ltmp162             # Loc expr size
	.short	.Lset30
.Ltmp162:
	.byte	82                      # DW_OP_reg2
.Ltmp163:
...
.Ldebug_loc11:
	.long	.Lfunc_begin6
	.long	.Ltmp90
.Lset31 = .Ltmp165-.Ltmp164             # Loc expr size
	.short	.Lset31
.Ltmp164:
	.byte	83                      # DW_OP_reg3
.Ltmp165:
...
.Ldebug_loc12:
	.long	.Lfunc_begin7
	.long	.Ltmp97
.Lset32 = .Ltmp167-.Ltmp166             # Loc expr size
	.short	.Lset32
.Ltmp166:
	.byte	80                      # DW_OP_reg0
.Ltmp167:
...
.Ldebug_loc13:
	.long	.Lfunc_begin7
	.long	.Ltmp99
.Lset33 = .Ltmp169-.Ltmp168             # Loc expr size
	.short	.Lset33
.Ltmp168:
	.byte	81                      # DW_OP_reg1
.Ltmp169:
...
.Ldebug_loc14:
	.long	.Lfunc_begin7
	.long	.Ltmp99
.Lset34 = .Ltmp171-.Ltmp170             # Loc expr size
	.short	.Lset34
.Ltmp170:
	.byte	82                      # DW_OP_reg2
.Ltmp171:
...
.Ldebug_loc15:
	.long	.Lfunc_begin7
	.long	.Ltmp99
.Lset35 = .Ltmp173-.Ltmp172             # Loc expr size
	.short	.Lset35
.Ltmp172:
	.byte	83                      # DW_OP_reg3
.Ltmp173:
...
.cc_bottom cc_trapinfo_1
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str2:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:60: error: conversion of out-of-bounds pointer to array reference\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                                                           ^~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_3
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str4:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:74: error: conversion of out-of-bounds pointer to array reference\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                                                                         ^~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_5
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str6:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:20: error: function arguments alias same memory region\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\nC:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:74: note: aliased object is here\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                                                                         ^~~~~~~\nC:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:106:60: note: aliased object is here\n                if(fl_writeData(write_offset, write_count, write_buffer, scratch ) != 0)\n                                                           ^~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_6
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str7:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:128:53: error: conversion of out-of-bounds pointer to array reference\n                int rc2 = fl_readData(offset, size, read_buffer);\n                                                    ^~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_8
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str9:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:129:32: error: out of bounds read from memcpy source parameter\n                memcpy(buffer, read_buffer, size );\n                               ^~~~~~~~~~~\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\string.h:14:44: note: expanded from macro 'memcpy'\n#define memcpy(s1, s2, n) _safe_memcpy(s1, s2, n)\n                                           ^\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\safe/string.h:11:57: note: expanded from macro '_safe_memcpy'\n#define _safe_memcpy(s1, s2, n) __builtin_memcpy_xc(s1, s2, n)\n                                                        ^\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_9
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str10:
.asciiz"C:/Users/takaaki/git/sw_xSSDAC/module_flash_memory_server/src/qspi_access.xc:129:24: error: out of bounds write to memcpy destination parameter\n                memcpy(buffer, read_buffer, size );\n                       ^~~~~~\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\string.h:14:40: note: expanded from macro 'memcpy'\n#define memcpy(s1, s2, n) _safe_memcpy(s1, s2, n)\n                                       ^\nC:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.4.1\\target/include/xc\\safe/string.h:11:53: note: expanded from macro '_safe_memcpy'\n#define _safe_memcpy(s1, s2, n) __builtin_memcpy_xc(s1, s2, n)\n                                                    ^\n"
	.section	.trap_info,"",@progbits
