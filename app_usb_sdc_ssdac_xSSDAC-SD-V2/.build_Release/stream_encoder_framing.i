# 1 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
# 37 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c"
...
# 37 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
...
# 38 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2

# 1 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/private/stream_encoder_framing.h" 1
# 37 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/private/stream_encoder_framing.h"
...
# 36 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/private/../FLAC/format.h" 2
...
# 37 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/private/stream_encoder_framing.h" 2
...
# 38 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/private/stream_encoder_framing.h" 2
...
# 39 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
...
# 40 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
...
# 41 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
...
# 42 "C:/Users/takaaki/git/sw_xSSDAC/module_libFLAC/source/stream_encoder_framing.c" 2
...
FLAC__bool FLAC__add_metadata_block(const FLAC__StreamMetadata *metadata, FLAC__BitWriter *bw)
{
 ...
 assert(FLAC__bitwriter_is_byte_aligned(bw));
 ...
 assert(metadata_length < (1u << FLAC__STREAM_METADATA_LENGTH_LEN));
 ...
 switch(metadata->type) {
  case FLAC__METADATA_TYPE_STREAMINFO:
   ...
   if(!FLAC__bitwriter_write_raw_uint32(bw, metadata->data.stream_info.max_framesize, FLAC__STREAM_METADATA_STREAMINFO_MAX_FRAME_SIZE_LEN))
    return 0;
   assert(FLAC__format_sample_rate_is_valid(metadata->data.stream_info.sample_rate));
  ...
  case FLAC__METADATA_TYPE_CUESHEET:
   assert(FLAC__STREAM_METADATA_CUESHEET_MEDIA_CATALOG_NUMBER_LEN % 8 == 0);
   ...
   for(i = 0; i < metadata->data.cue_sheet.num_tracks; i++) {
    ...
    if(!FLAC__bitwriter_write_raw_uint32(bw, track->number, FLAC__STREAM_METADATA_CUESHEET_TRACK_NUMBER_LEN))
     return 0;
    assert(FLAC__STREAM_METADATA_CUESHEET_TRACK_ISRC_LEN % 8 == 0);
...
FLAC__bool FLAC__frame_add_header(const FLAC__FrameHeader *header, FLAC__BitWriter *bw)
{
 ...
 assert(header->blocksize > 0 && header->blocksize <= (65535u));

 assert((65535u) <= 65535u);
 blocksize_hint = 0;
 ...
 assert(FLAC__format_sample_rate_is_valid(header->sample_rate));
 sample_rate_hint = 0;
 ...
 assert(header->channels > 0 && header->channels <= (1u << FLAC__STREAM_METADATA_STREAMINFO_CHANNELS_LEN) && header->channels <= (8u));
