...
const unsigned num_freqs_a1 = (((3)>((0 +1 +1 +1 +1)))?(3):((0 +1 +1 +1 +1)));
...
unsigned char cfgDesc_Audio1[] =
{
    ...
    0x09,
    USB_DESCTYPE_CONFIGURATION,
    ((18 + ((8 + (0) + (1)) + ((0) * (17 + ((0)) + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) + ((0) * 61) + ((1) * 70)) & 0xFF),
    ((18 + ((8 + (0) + (1)) + ((0) * (17 + ((0)) + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) + ((0) * 61) + ((1) * 70)) >> 8),
    (1+(0) + (1)),
    0x01,
    0x00,
    ...
    0x01,
    0x00, 0x01,
    (((8 + (0) + (1)) + ((0) * (17 + ((0)) + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) & 0xFF),
    (((8 + (0) + (1)) + ((0) * (17 + ((0)) + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) >> 8),
    ((0) + (1)),
...
# 2514 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    ...
    0x01,
    0x05,
    ((((((96000 +999)/1000)+1) * ((2))) * (24/8))&0xff),
    ((((((96000 +999)/1000)+1) * ((2))) * (24/8))&0xff00)>>8,
    0x01,
    0x00,
