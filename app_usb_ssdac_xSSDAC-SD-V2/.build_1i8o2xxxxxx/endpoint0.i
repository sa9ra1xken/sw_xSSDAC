...
# 1 "C:\\\\Users\\\\takaaki\\\\git\\\\sw_xSSDAC\\\\app_usb_ssdac_xSSDAC-SD-V2\\\\.build_1i8o2xxxxxx\\\\xSSDAC-SD-V2.h" 1 3
...
StringDescTable_t g_strTable =
{
    ...
    .productStr_Audio1 = "xCORE USB Audio 1.0",
    .outputInterfaceStr_Audio1 = "xCORE USB Audio 1.0" " """,
    .inputInterfaceStr_Audio1 = "xCORE USB Audio 1.0" " """,
    .usbInputTermStr_Audio1 = "xCORE USB Audio 1.0" " """,
    .usbOutputTermStr_Audio1 = "xCORE USB Audio 1.0" " """,
...
# 2216 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
const unsigned num_freqs_a1 = (((3)>((0 +1)))?(3):((0 +1)));
# 2266 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
unsigned char cfgDesc_Audio1[] =
{

    0x09,
    USB_DESCTYPE_CONFIGURATION,
    ((18 + ((8 + (0) + (1)) + ((0) * (17 + 6 + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) + ((0) * 61) + ((1) * 70)) & 0xFF),
    ((18 + ((8 + (0) + (1)) + ((0) * (17 + 6 + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) + ((0) * 61) + ((1) * 70)) >> 8),
    (1+(0) + (1)),
    0x01,
    0x00,
    ...
    0x01,
    0x00, 0x01,
    (((8 + (0) + (1)) + ((0) * (17 + 6 + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) & 0xFF),
    (((8 + (0) + (1)) + ((0) * (17 + 6 + num_freqs_a1 * 3)) + ((1) * (17 + ((2)) + (num_freqs_a1 *3)))) >> 8),
    ((0) + (1)),
    ...
    0x03,
# 2358 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    0x00,
    ...
    0x0A,
    0x00,
# 2434 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x04,
    0x01,
    0x00,
    ...
    num_freqs_a1,
# 2489 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    (44100 & 0xff),((44100 & 0xff00)>> 8),((44100 & 0xff0000)>> 16),
    (44100 & 0xff),((44100 & 0xff00)>> 8),((44100 & 0xff0000)>> 16),
# 2514 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    0x44, 0xAC, 0x00,
# 2530 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x05,
    0x01,
    0x05,
    ...
    0x04,
    0x0,
# 2680 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
};
...
# 491 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
           ...
           asm ("chkct res[%0], %1" :: "r" (c_audioControl), "r" (0x1));
                        ...
                        {
# 607 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
...
# 621 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
        ...
        if(result == XUD_RES_ERR)
        {
            ...
            if (!DFU_mode_active)
            {
# 729 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
