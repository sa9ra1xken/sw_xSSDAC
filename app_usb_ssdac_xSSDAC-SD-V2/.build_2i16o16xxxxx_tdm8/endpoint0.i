...
# 1 "C:\\\\Users\\\\takaaki\\\\git\\\\sw_xSSDAC\\\\app_usb_ssdac_xSSDAC-SD-V2\\\\.build_2i16o16xxxxx_tdm8\\\\xSSDAC-SD-V2.h" 1 3
...
# 1543 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint_3 =
    {
        ...
        .bEndpointAddress = (ENDPOINT_NUMBER_OUT_AUDIO),
        .bmAttributes = 0x05,
        .wMaxPacketSize = (((((96000 +7999)/8000)+1) * 16) * (32/8)),
        .bInterval = 1,
    },
...
const unsigned g_chanCount_In_HS[1] = {16,
...
# 650 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
                if(g_curUsbSpeed == XUD_SPEED_HS)
                {
                    ...
                    cfgDesc_Audio2.Audio_Out_Endpoint_3.wMaxPacketSize = (((((96000 +7999)/8000)+1) * 16) * (32/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface_3.bNrChannels = 16;
