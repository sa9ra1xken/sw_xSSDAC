...
# 1 "C:\\\\Users\\\\takaaki\\\\git\\\\sw_xSSDAC\\\\app_usb_ssdac_xSSDAC-SD-V2\\\\.build_2i8o8xxxxx_tdm8_slave\\\\xSSDAC-SD-V2.h" 1 3
...
# 1365 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint =
    {
        ...
        .bmAttributes = 0x05,
        .wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * 4),
        .bInterval = 1,
    },
...
# 1464 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint_2 =
    {
        ...
        .bEndpointAddress = (ENDPOINT_NUMBER_OUT_AUDIO),
        .bmAttributes = 0x05,
        .wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * (16/8)),
        .bInterval = 1,
    },
...
# 1543 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint_3 =
    {
        ...
        .bEndpointAddress = (ENDPOINT_NUMBER_OUT_AUDIO),
        .bmAttributes = 0x05,
        .wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * (32/8)),
        .bInterval = 1,
    },
...
# 650 "C:/Users/takaaki/git/sw_xSSDAC/module_usb_audio/endpoint0/endpoint0.c"
                if(g_curUsbSpeed == XUD_SPEED_HS)
                {
                    ...
                    cfgDesc_Audio2.Audio_CS_Control_Int.Audio_Out_InputTerminal.bNrChannels = 8;

                    cfgDesc_Audio2.Audio_Out_Format.bSubslotSize = 4;
                    cfgDesc_Audio2.Audio_Out_Format.bBitResolution = 24;
                    cfgDesc_Audio2.Audio_Out_Endpoint.wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * 4);
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface.bNrChannels = 8;


                    cfgDesc_Audio2.Audio_Out_Format_2.bSubslotSize = (16/8);
                    cfgDesc_Audio2.Audio_Out_Format_2.bBitResolution = 16;
                    cfgDesc_Audio2.Audio_Out_Endpoint_2.wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * (16/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface_2.bNrChannels = 8;



                    cfgDesc_Audio2.Audio_Out_Format_3.bSubslotSize = (32/8);
                    cfgDesc_Audio2.Audio_Out_Format_3.bBitResolution = 32;
                    cfgDesc_Audio2.Audio_Out_Endpoint_3.wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * (32/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface_3.bNrChannels = 8;
                    ...
                    cfgDesc_Audio2.Audio_In_Endpoint.wMaxPacketSize = (((((96000 +7999)/8000)+1) * 8) * 4);
