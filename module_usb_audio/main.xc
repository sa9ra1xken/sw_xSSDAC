...
#ifndef _EXCLUDE_MODULE_USB_AUDIO_MAIN //added by sakurai for SSDAC
...
#if (I2S_CHANS_DAC + I2S_CHANS_ADC > 0) //added for ssdsc by sakurai
#ifndef CODEC_MASTER
...
#endif  //added for ssdsc by sakurai
...
#else									//added for ssdsc by sakurai
...
void usb_audio_io(chanend c_aud_in, chanend ?c_adc,
    ...
    , chanend c_pdm_pcm
#endif
    , chanend ?c_dac_control     //added by sakurai for ssdac
)
{
#ifdef MIXER
    chan c_mix_out;
...
#endif
#define USE_SSDAC			//added by sakurai for ssdac
#ifndef USE_SSDAC			//added by sakurai for ssdac
            audio(AUDIO_CHANNEL,
#if defined(SPDIF_TX) && (SPDIF_TX_TILE != AUDIO_IO_TILE)
                c_spdif_tx,
#endif
...
#else												//added by sakurai for ssdac
        audio_xss(									//added by sakurai for ssdac
                AUDIO_CHANNEL						//added by sakurai for ssdac
#if _DAC_MODE_SELECTOR == _DAC_MODE_SELECTOR_NONE	//added by sakurai for ssdac
...
#endif																//added by sakurai for SSDAC
#if _DAC_MODE_SELECTOR == _DAC_MODE_SELECTOR_EXPLORER				//added by sakurai for SSDAC
        on tile[AUDIO_IO_TILE]: dac_mode_selector(c_dac_control);	//added by sakurai for SSDAC
#endif																//added by sakurai for SSDAC
    }
...
#endif //_EXCLUDE_MODULE_USB_AUDIO_MAIN
