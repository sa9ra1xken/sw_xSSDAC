...
#if (I2S_CHANS_DAC + I2S_CHANS_ADC > 0) //added by sakurai for ssdac
...
unsigned int divide, unsigned curSamFreq)
{
...
#if (I2S_CHANS_DAC != 0) || (I2S_CHANS_ADC != 0) // added for ssdac by sakurai
    ...
    clearbuf(p_bclk);
#endif // added for ssdac by sakurai
    ...
    #if (I2S_CHANS_DAC + I2S_CHANS_ADC > 0) // added for ssdac by sakurai
